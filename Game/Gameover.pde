class Gameover{
  ...
  public Gameover(){
    yes = new Button(new PVector(300, 400), new PVector(400, 200), 50, 0, border, backgroundOff, backgroundOn, textColor, text);
    no = new Button(new PVector(300, 400), new PVector(400, 200), 50, 0, border, backgroundOff, backgroundOn, textColor, text);
